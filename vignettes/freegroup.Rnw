...
It has a rich structure and illustrates many concepts of elementary
group theory.  The \pkg{freegroup} package provides some functionality
for manipulating the free group on a finite list of
symbols~\citep{wikipedia2019}.  Informally, the {\em free group}
